            ...
            <table style="width:100%;text-align: center">
                ...
                <tr>
                    <td>
                      ...
                      <td>
                          <input type='text' style='display:none' id='student_registration_no_<?php echo $i; ?>' name='student_registration_no_<?php echo $i; ?>' value='<?php echo $resultlist->registration_no;?>'>
