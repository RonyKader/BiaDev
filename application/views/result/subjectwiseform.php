...
input.value= document.getElementById("subject_id").value;
input.id= "subject_id_"+columnno;
input.name= "subject_id_"+columnno;
    }
    if(j==2)
    {
input.type = "text";
//input.style.display="none";
input.value=  document.getElementById('subject_id').options[document.getElementById('subject_id').selectedIndex].text;

 
input.id= "subject_name_"+columnno;
input.name= "subject_name_"+columnno;
    }
if(j==3)
    {
input.type = "text";
