<div id="main-content" class="clearfix">
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo site_url('session');?>">Session</a>
                                    ...
                                    <div class="step-content row-fluid position-relative">
                                        <div class="step-pane active" id="step1">
                                            ...
                                            <form class="form-horizontal"  method="post" action="" name="frm">
                                                 ...
                                                 <div class="control-group  <?php if(form_error('session_name')){?>error<?php }?>">
                                                    <label class="control-label" for="session_name">Session Name:</label>

                                                    <div class="controls">
                                                       <input type="text" id="session_name" name="session_name" class="span6" value="<?php echo $row['session_name']?>">
                                                    </div>
                                                </div>
