...
<div id="main-content" class="clearfix">
 ...
 Sponsored By
           ...
           <tr>
            <td>
                <div class="control-group">
                                                    <label class="control-label" for="course_id">Counseling Fee </label>

                                                
                                                      <div class="controls">
                                                         <input type="text" style="width:300px" id="counseling_fee" name="counseling_fee" class="span6" value="<?php echo $row['counseling_fee']?>">
